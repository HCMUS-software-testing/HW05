...
Manual follow-up: rerun each official workload with the corrected monitor, capture Activity Monitor/JMeter screenshots, and add them under `evidence/screenshots/`.
