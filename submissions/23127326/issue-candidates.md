...
| Checkout cleanup/total | Server tự tính total và làm rỗng cart | **Đã tái hiện**: assertion `POST_CHECKOUT_CART` fail ở cả 4 workload; HTTP error `0%` | JTL thô, `report/metrics-resource-rerun-20260830/*.json`, GitHub Issue #2, `github-issue-2.png` |
